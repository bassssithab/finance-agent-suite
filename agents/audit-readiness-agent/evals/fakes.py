...
audit_readiness_agent.llm.draft_response makes, without depending on the
anthropic package being installed or costing real API tokens. Copied from
technical-accounting-agent/evals/fakes.py — identical call shape.
"""
